...
function josh_prompt {
  ...
  prompt="%{$terminfo[bold]$FG[226]%}${current_dir}%{$reset_color%}$prompt%{%F{red}%}$(rvm_prompt_info || rbenv_prompt_info)%{$reset_color%} $(current_branch) [%*]"
